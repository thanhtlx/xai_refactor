    ...
    static ASTVisitor create(String ruleIdStr, CompilationUnit cu_, Document document_, String outputDirPath_, ArrayList targetLines) {
        ...
        switch (ruleID) {
            ...
            case ReorderParameter:
                return  new ReoderParameter(cu_, document_, outputDirPath_, targetLines);
            case ChangeCondition:
                return  new ReverseCondition(cu_, document_, outputDirPath_, targetLines);
            case RemoveCondition:
                return  new RemoveControlStatement(cu_, document_, outputDirPath_, targetLines);
            case ChangeOperator:
                return  new ChangeOperator(cu_, document_, outputDirPath_, targetLines);
            case RemoveUseStatement:
                return  new RemoveUseStatement(cu_, document_, outputDirPath_, targetLines);
            default:
